    ...
    <div className="min-h-screen bg-[#f1f3f7] text-[#0d1117]">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 md:px-8">
        ...
        <div className="mt-10 space-y-8 leading-7 text-[#0d1117]">
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">1. Who this policy covers</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">2. Information we collect</h2>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">3. How we use your information</h2>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">4. Who we share it with</h2>
            <ul className="ml-5 list-disc space-y-2">
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">5. Data retention</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">6. Your rights</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">7. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">8. Security</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">9. International transfers</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">10. Children</h2>
            <p>RealReach Agency is not intended for anyone under 18, and we don&apos;t knowingly collect data from them.</p>
          </section>

          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">11. Changes to this policy</h2>
            <p>
        ...
        <p className="mt-14 text-sm">
          <Link href="/terms" className="font-bold text-[#16255c] hover:underline">
