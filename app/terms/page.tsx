  ...
  return (
    <div className="min-h-screen bg-[#f1f3f7] text-[#0d1117]">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 md:px-8">
        <div className="mb-10 rounded-[12px] bg-[#feb930]/15 p-5 text-sm leading-6 text-[#5b6472]">
          <strong className="text-[#0d1117]">Draft — not legal advice.</strong> This is placeholder
        ...
        <p className="text-[11px] font-extrabold uppercase tracking-[0.2em] text-[#16255c]">Legal</p>
        <h1 className="mt-3 font-display text-4xl font-extrabold tracking-tight">Terms of Service</h1>
        <p className="mt-3 text-sm text-[#5b6472]">Last updated: [DATE]</p>

        <div className="mt-10 space-y-8 leading-7 text-[#0d1117]">
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">1. Who we are</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">2. What RealReach Agency is (and isn&apos;t)</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">3. Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">4. Jobs, briefs, and applications</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">5. Payments and escrow</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">6. Revisions, disputes, and refunds</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">7. Content and intellectual property</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">8. Prohibited conduct</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">9. Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">10. Changes to these Terms</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">11. Governing law</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-lg font-bold text-[#0d1117]">12. Contact</h2>
            <p>
        ...
        <p className="mt-14 text-sm">
          <Link href="/privacy" className="font-bold text-[#16255c] hover:underline">
      ...
      <footer className="border-t border-[#0d1117]/[0.07] bg-[#f1f3f7] px-6 py-10 text-[#5b6472]">
        <div className="mx-auto flex max-w-3xl items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm">
            <Link href="/help" className="transition hover:text-[#0d1117]">Help Center</Link>
