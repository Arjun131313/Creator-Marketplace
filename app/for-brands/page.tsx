        ...
        <div className="mx-auto max-w-3xl px-6 text-center md:px-8">
          ...
          <div className="mx-auto mt-14 grid max-w-lg grid-cols-2 gap-6 border-t border-[#f1f3f7]/15 pt-8">
            <div>
              ...
              <p className="mt-1 text-xs uppercase tracking-wide text-[#8891a3]">UK creators</p>
            </div>
            <div>
              <p className="font-display text-3xl font-extrabold">{openJobCount ?? "—"}</p>
              <p className="mt-1 text-xs uppercase tracking-wide text-[#8891a3]">Live briefs right now</p>
            </div>
          </div>
        </div>
      </section>
